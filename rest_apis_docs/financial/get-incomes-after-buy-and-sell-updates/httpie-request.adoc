[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2021,12,28,22,51,48,178275145],"toDate":[2021,12,28,22,51,58,385255450]}' | http POST 'http://localhost:8080/api/user/financial/incomes/' \
