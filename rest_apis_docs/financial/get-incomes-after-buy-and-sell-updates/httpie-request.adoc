[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2021,8,31,16,28,22,737555532],"toDate":[2021,8,31,16,28,33,541411081]}' | http POST 'http://localhost:8080/api/user/financial/incomes/' \
