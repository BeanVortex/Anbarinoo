[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2021,9,6,23,33,58,269766644],"toDate":[2021,9,6,23,34,8,408689853]}' | http POST 'http://localhost:8080/api/user/financial/incomes/' \
