[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2021,11,10,13,12,4,681538209],"toDate":[2021,11,10,13,12,15,17916470]}' | http POST 'http://localhost:8080/api/user/financial/costs/' \
