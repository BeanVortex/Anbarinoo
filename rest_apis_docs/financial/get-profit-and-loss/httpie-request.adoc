[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2021,12,28,13,42,16,590314654],"toDate":[2021,12,28,13,42,26,779224247]}' | http POST 'http://localhost:8080/api/user/financial/profit-loss/' \
