[source,bash]
----
$ echo '{"id":null,"firstBuyId":null,"canUpdate":true,"name":"product1Updated","description":"desc1Updated","images":null,"price":50.05,"tax":null,"category":null,"totalCount":50500,"createdAt":null,"updatedAt":null}' | http PUT 'http://localhost:8080/api/category/products/update/7/' \
