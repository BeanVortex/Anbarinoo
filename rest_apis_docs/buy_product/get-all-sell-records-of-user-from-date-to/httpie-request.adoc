[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2021,8,31,16,29,49,985618280],"toDate":[2021,8,31,16,29,50,276529950]}' | http POST 'http://localhost:8080/api/category/products/buy/get-by-user/date/2/' \
