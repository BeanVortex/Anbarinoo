[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2022,1,10,1,9,35,205449334],"toDate":[2022,1,10,1,9,35,293258366]}' | http POST 'http://localhost:8080/api/category/products/sell/get-by-user/date/2/' \
