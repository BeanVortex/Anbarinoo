[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2021,9,6,23,38,12,1711474],"toDate":[2021,9,6,23,38,12,151582483]}' | http POST 'http://localhost:8080/api/category/products/sell/get-by-user/date/2/' \
