[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2021,11,10,13,12,17,131764612],"toDate":[2021,11,10,13,12,17,245999523]}' | http POST 'http://localhost:8080/api/category/products/sell/get-by-user/date/2/' \
