[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2021,8,31,16,27,56,843476634],"toDate":[2021,8,31,16,27,57,213801538]}' | http POST 'http://localhost:8080/api/category/products/sell/get-by-user/date/2/' \
