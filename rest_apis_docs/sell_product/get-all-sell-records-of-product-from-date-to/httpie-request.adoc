[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2022,1,10,1,9,35,205449334],"toDate":[2022,1,10,1,9,35,279280221]}' | http POST 'http://localhost:8080/api/category/products/sell/get-by-product/date/5/' \
