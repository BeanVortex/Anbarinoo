[source,bash]
----
$ echo '{"costs":null,"incomes":null,"profit":null,"loss":null,"fromDate":[2022,2,13,16,48,35,216608169],"toDate":[2022,2,13,16,48,35,289830195]}' | http POST 'http://localhost:8080/api/category/products/sell/get-by-product/date/5/' \
