[source,bash]
----
$ echo '{"nameOf":"Other","payTo":"Me","isDebt":false,"isCheckedOut":false,"amount":1564,"validTill":"2021-09-14T23:33:54.424704802"}' | http PUT 'http://localhost:8080/api/user/financial/debt-demand/update/4/' \
