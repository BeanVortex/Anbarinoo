[source,bash]
----
$ echo '{"nameOf":"Other","payTo":"Me","isDebt":false,"isCheckedOut":false,"amount":1564,"validTill":"2021-11-18T13:12:19.228434828"}' | http PUT 'http://localhost:8080/api/user/financial/debt-demand/update/4/' \
