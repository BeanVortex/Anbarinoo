[source,bash]
----
$ echo '{"nameOf":"Me2","isDebt":false,"isCheckedOut":true,"validTill":"2022-02-23T16:48:23.215885464"}' | http POST 'http://localhost:8080/api/user/financial/cheque/update/4/' \
