[source,bash]
----
$ echo '{"nameOf":"Me2","isDebt":false,"isCheckedOut":true,"validTill":"2022-01-20T01:09:19.082120015"}' | http POST 'http://localhost:8080/api/user/financial/cheque/update/4/' \
