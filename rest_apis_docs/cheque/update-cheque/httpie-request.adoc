[source,bash]
----
$ echo '{"nameOf":"Me2","isDebt":false,"isCheckedOut":true,"validTill":"2021-09-16T23:38:26.654111931"}' | http POST 'http://localhost:8080/api/user/financial/cheque/update/4/' \
